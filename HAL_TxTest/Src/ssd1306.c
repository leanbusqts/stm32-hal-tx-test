...
void ssd1306_WriteCommand(uint8_t command)
{
	...
	//HAL_I2C_Mem_Write_IT(&hi2c1,SSD1306_I2C_ADDR,0x00,1,&command,1);
}
...
void ssd1306_UpdateScreen(void) 
{
	...
	for (i = 0; i < 8; i++) {
		...
		//HAL_I2C_Mem_Write_IT(&hi2c1,SSD1306_I2C_ADDR,0x40,1,&SSD1306_Buffer[SSD1306_WIDTH * i],SSD1306_WIDTH);
	}
}
